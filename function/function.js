...
function addEvent(obj,event,name){
    if(obj.attachEvent){
        return obj.attachEvent("on"+event,name);
    }else if(obj.addEventListener){
        return obj.addEventListener(event,name,false);
    }
}



function removeEvent(obj,event,name){
    if(obj.detachEvent){
        return obj.detachEvent("on"+event,name);
    }else if(obj.removeEventListener){
        return obj.removeEventListener(event,name,false);
    }
}
